					...
					<div class="card-body">
						...
						<form action="<?php base_url('') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('expedition') ? 'is-invalid' : '' ?>" type="text" name="expedition" placeholder="JNE, Si Cepat, Pos, dll" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('sending_price') ? 'is-invalid' : '' ?>" type="number" name="sending_price" min="0" placeholder="0" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('weight_packet') ? 'is-invalid' : '' ?>" type="number" name="weight_packet" min="0" placeholder="0" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('date_order') ? 'is-invalid' : '' ?>" type="date" name="date_order" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('date_send') ? 'is-invalid' : '' ?>" type="date" name="date_send" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('payment_status') ? 'is-invalid' : '' ?>" type="text" name="payment_status" placeholder="" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('buyer_status') ? 'is-invalid' : '' ?>" type="text" name="buyer_status" placeholder="" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('book_order_out') ? 'is-invalid' : '' ?>" type="number" name="book_order_out" min="0" placeholder="0" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('id_group') ? 'is-invalid' : '' ?>" type="number" name="id_group" min="0" placeholder="0" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('order_group') ? 'is-invalid' : '' ?>" type="number" name="order_group" min="0" placeholder="0" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('description') ? 'is-invalid' : '' ?>" type="text" name="description" placeholder="" />
								<div class="invalid-feedback">
